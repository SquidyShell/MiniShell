...
SRC = main.c exec.c utils.c path.c wait.c  ft_cd.c ft_env.c ft_echo.c ft_exit.c ft_export.c ft_pwd.c ft_unset.c redirs.c redirs_utils.c history.c gnl.c init.c
