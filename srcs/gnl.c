...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/12 19:03:10 by legrandc          #+#    #+#             */
/*   Updated: 2024/03/12 20:20:13 by legrandc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	read_file(int fd, t_string *string)
{
	ssize_t	read_ret;
	ssize_t	ret;
	char	*tmp;
...
char	*gnl_no_nl(int fd)
{
	...
	ft_strlcpy(save, string.content + line_len
		+ (string.content[line_len] != 0), string.len - line_len + 1);
